...
public class CityUtils {
	...
	public static void main(String[] args){
		...
		System.out.println(cu.getCity("Sichuan"));
		System.out.println(cu.getCity("Chengdu"));
	}
	
	public static String getCity(Object object){
		
		JSONObject jsonObject = JSONObject.fromObject(cityString);
		JSONArray array= jsonObject.getJSONArray("city");
		
         for(int i=0;i<array.size();i++){
            // System.out.println("---------------");
             JSONObject subObject=array.getJSONObject(i);
            // System.out.println("label="+subObject.get("label"));
            // System.out.println("name="+subObject.get("name"));
            // System.out.println("pinyin="+subObject.get("pinyin"));
        	 if(object.equals(subObject.get("pinyin"))){
        		 return subObject.get("name").toString();
